...
Provides a single authoritative developer guide for setting up, understanding, and running the literary game project locally. Covers prerequisites, monorepo architecture, and launch commands.
