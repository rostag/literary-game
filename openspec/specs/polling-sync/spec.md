...
Defines the HTTP polling mechanism that replaced WebSocket-based real-time communication. Clients poll the server at regular intervals for game state updates, eliminating the need for persistent connections.
